...
void KFuzzyMatcherTest::testMatchSimple_data()
{
    ...
    QTest::newRow("Empty Pattern") << QLatin1String("") << QStringLiteral("Nam") << true;
}
...
void KFuzzyMatcherTest::testMatch_data()
{
    ...
    QTest::newRow("pattern=") << QLatin1String("")
                          << QStringList{
                                QStringLiteral("th"),
                                QStringLiteral("ths"),
                                QStringLiteral("thsi")
...
void KFuzzyMatcherTest::testMatchedRanges_data()
{
    ...
    QTest::newRow("Emtpy") << QLatin1String("") << QLatin1String("") << QList<Range>{} << true;
