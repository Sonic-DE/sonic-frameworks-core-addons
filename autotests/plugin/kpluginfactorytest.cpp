...
private Q_SLOTS:
    void testCreate()
    {
        ...
        MyPlugin *obj = factory->create<MyPlugin>(this);
        QVERIFY(obj);
        QCOMPARE(obj->objectName(), QString::fromLatin1("SimplePluginClass"));

        QObject *obj2 = factory->create<QObject>(this);
        QVERIFY(obj2);
        QCOMPARE(obj2->objectName(), QString::fromLatin1("SimplePluginClass2"));
        QVERIFY(obj != obj2);
        delete obj;
        delete obj2;
