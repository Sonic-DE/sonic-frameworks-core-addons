...
public:
    ...
    enum LicenseKey {
        ...
        ODbL_V1 = 9, ///< ODbL_V1 @since 6.10, see https://spdx.org/licenses/ODbL-1.0.html
        Apache_V2 = 10, ///< Apache_V2 @since 6.10, see https://spdx.org/licenses/Apache-2.0.html
        FTL = 11, ///< FTL @since 6.10, see https://spdx.org/licenses/FTL.html
        BSL_V1 = 12, ///< BSL_V1 @since 6.10, see https://spdx.org/licenses/BSL-1.0.html
        BSD_3_Clause = 13, ///< BSD_3_CLAUSE @since 6.10, see https://spdx.org/licenses/BSD-3-Clause.html
        CC0_V1 = 14, ///< CC0_V1 @since 6.10, see https://spdx.org/licenses/CC0-1.0.html
    };
    Q_ENUM(LicenseKey)
