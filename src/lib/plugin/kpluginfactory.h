 ...
 * @since 5.44
 */
#ifdef KPLUGINFACTORY_PLUGIN_NAME
#define K_PLUGIN_CLASS_WITH_JSON(classname, jsonFile) K_PLUGIN_FACTORY_WITH_JSON(KPLUGINFACTORY_PLUGIN_NAME, jsonFile, registerPlugin<classname>();)
#else
