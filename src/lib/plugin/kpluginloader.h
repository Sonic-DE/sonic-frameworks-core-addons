...
#if KCOREADDONS_ENABLE_DEPRECATED_SINCE(5, 85)
 ...
 * @deprecated Since 5.85, the @p findPluginsById, @p findPlugins and @p factory methods have been imported to @ref KPluginMetaData.
...
public:
     ...
     * @deprecated Since 5.85, use @ref KPluginMetaData::factory instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use KPluginFactory::loadFactory or KPluginFactory::instantiatePlugin instead")
     ...
     *
     * \see fileName()
     * @deprecated Since 5.85, use @ref KPluginMetaData::pluginId instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use KPluginMetaData::pluginId instead")
     ...
     * @deprecated Since 5.85, use @ref KPluginMetaData::version() or a versioned namespace instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use KPluginMetaData::version or a versioned namespace instead")
     ...
     *
     * @since 5.0
     * @deprecated Since 5.85, use QPluginLoader::findPlugin() or KPluginMetaData::findPluginById instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::findPlugin() or KPluginMetaData::findPluginById instead")
     ...
     * @deprecated Since 5.85, use QPluginLoader::errorString() instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::errorString() instead")
     ...
     * @deprecated Since 5.85, use QPluginLoader::fileName() instead, in case of complex query logic consider using @ref KPluginLoader::findPlugins
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::fileName() instead, in case of complex query logic consider using KPluginLoader::findPlugins")
     ...
     * @deprecated Since 5.85, use QPluginLoader::instance() instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::instance() instead")
    QObject *instance();
     ...
     * @deprecated Since 5.85, use QPluginLoader::isLoaded() instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::isLoaded() instead")
    bool isLoaded() const;
     ...
     * @deprecated Since 5.85, use QPluginLoader::load() instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::load() instead")
    bool load();
     ...
     * @deprecated Since 5.85, use QPluginLoader::loadHints() instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::loadHints() instead")
     ...
     * @deprecated Since 5.85, use QPluginLoader::metaData() or @ref KPluginMetaData instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::metaData() or KPluginMetaData instead")
     ...
     * @deprecated Since 5.85, use QPluginLoader::setLoadHints instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::setLoadHints instead")
     ...
     * @deprecated Since 5.85, use QPluginLoader::unload() instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use QPluginLoader::unload() instead")
    bool unload();
     ...
     *
     * @since 5.1
     * @deprecated Since 5.85 create instances from the KPluginMetaData::findPlugins result instead. In case
     ...
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Create instances from the KPluginMetaData::findPlugins result instead")
     ...
     *
     * @since 5.1
     * @deprecated Since 5.85 use @ref KPluginMetaData::findPlugins instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use KPluginMetaData::findPlugins instead")
     ...
     *
     * @since 5.11
     * @deprecated Since 5.85 use @ref KPluginMetaData::findPluginsById instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use KPluginMetaData::findPluginsById instead")
     ...
     *
     * @since 5.1
     * @deprecated Since 5.85 use @ref KPluginMetaData::findPlugins instead. This will warn about invalid plugin
