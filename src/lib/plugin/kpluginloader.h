...
public:
     ...
     * @deprecated Since 5.84, use KPluginMetaData::factory instead
     */
     ...
     *
     * \see fileName()
     * @deprecated Since 5.84, use KPluginMetaData::pluginId instead
     */
     ...
     * @deprecated Since 5.84, use QPluginLoader::fileName() instead, in case of complex query logic consider using KPluginLoader::findPlugins
     */
     ...
     * @deprecated Since 5.84, use QPluginLoader::metaData() or KPluginMetaData instead
     */
     ...
     *
     * @since 5.1
     * @deprecated Since 5.84 use KPluginMetaData::findPlugins instead. This will warn about invalid plugin
