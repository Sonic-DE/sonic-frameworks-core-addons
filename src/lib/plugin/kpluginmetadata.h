...
private:
    // This is only in the findPlugins context relevant, of one has a static plugin in Qt's vector
    // registered and does not want any metadata, using KPluginMetaData makes no sense
