...
public:
     ...
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "Use KPluginMetaData(QPluginLoader) instead")
     ...
     * @deprecated Since 5.85, use @ref KPluginFactory::loadFactory or @ref KPluginFactory::instantiatePlugin when using
     * KPluginFactory. Otherwise use QPluginLoader::instance() instead.
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 85, "See API docs")
