 ...
 * Keywords           | keywords()           | string (since 5.92, "," as separator)
...
class KCOREADDONS_EXPORT KPluginMetaData
{
    ...
    Q_PROPERTY(QStringList keywords READ keywords CONSTANT) ///< @since 5.92
    Q_PROPERTY(QStringList untranslatedKeywords READ untranslatedKeywords CONSTANT) ///< @since 5.92
