...
public:
     ...
     *
     * @since 5.18
     * @deprecated Since 5.86, deprecate for lack of usage. Use a meaningful custom key in the json metadata instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 86, "Deprecate for lack of usage, use a meaningful custom key in the json metadata instead")
