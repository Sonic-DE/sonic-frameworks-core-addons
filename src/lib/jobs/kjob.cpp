...
#endif
        Q_EMIT processedAmountChanged(this, unit, amount);
...
#endif
        Q_EMIT totalAmountChanged(this, unit, amount);
        if (unit == d->progressUnit) {
...
#endif
        Q_EMIT percentChanged(this, percentage);
    }
}
...
#endif
            Q_EMIT percentChanged(this, d->percentage);
        }
    }
}
