...
Q_SIGNALS:
     ...
     *
     * @deprecated since 5.80, use the KJob::totalAmoutChanged(KJob *, KJob::Unit, qulonglong) signal instead
     */
    KCOREADDONS_DEPRECATED_VERSION(5, 80, "Use KJob::totalAmoutChanged(KJob *, KJob::Unit, qulonglong) signal")
