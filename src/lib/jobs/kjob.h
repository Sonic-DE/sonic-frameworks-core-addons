...
public:
    ...
    /**
     * Can be used to indicate to classes that are listening to signals from a job
     ...
     * @since 5.92
     */
    void setHideFinishedNotification();

    /**
     * This method does the reverse of setHideFinishedNotification().
     *
     * @see setHideFinishedNotification()
     *
     * @since 5.92
     */
    void setDisplayFinishedNotification();
     ...
     * @since 5.92
     */
    bool shouldHideFinishedNotification();
