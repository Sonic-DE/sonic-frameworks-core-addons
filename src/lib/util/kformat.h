...
public:
     ...
     * iec = format.formatValue(1024, QStringLiteral("B/s"), 1, KFormat::UnitPrefix::AutoAdjust, KFormat::MetricBinaryDialect);
     * jedec = format.formatValue(1024, QStringLiteral("B/s");
     * metric = format.formatValue(1000, QStringLiteral("B/s");
     * @endcode
     *
     * @param value value to be formatted
     * @param precision number of places after the decimal point to use.  KDE uses
