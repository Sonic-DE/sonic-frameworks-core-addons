 ...
 * that shell builtins are not recognized - you need to do that
 ...
 * \li A string enclosed in $'' is not split. Within the string, the
 ...
 * \li The \c circumflex is the escape char for everything including
 *   itself.
 * \endlist
 *
