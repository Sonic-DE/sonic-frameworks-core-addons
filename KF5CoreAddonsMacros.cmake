...
function(kcoreaddons_add_plugin plugin)
    ...
    if(NOT ("${ECM_GLOBAL_FIND_VERSION}" VERSION_LESS "5.87.0"))
    ...
    if ("${ECM_GLOBAL_FIND_VERSION}" VERSION_GREATER_EQUAL "5.87.0")
        target_compile_definitions(${plugin} PRIVATE KPLUGINFACTORY_PLUGIN_NAME=${plugin}_factory)
    endif()
