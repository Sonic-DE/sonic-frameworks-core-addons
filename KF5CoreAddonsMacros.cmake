...
function(kcoreaddons_add_plugin plugin)
    ...
    if (KCA_ADD_PLUGIN_STATIC)
        ...
        set_property(TARGET ${plugin} PROPERTY AUTOMOC_MOC_OPTIONS -MX-KDE-PluginNamespace=${KCA_ADD_PLUGIN_INSTALL_NAMESPACE} -MX-KDE-FileName=${KCA_ADD_PLUGIN_INSTALL_NAMESPACE}/${plugin})
