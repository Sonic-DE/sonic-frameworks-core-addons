...
function(kcoreaddons_add_plugin plugin)
    ...
    if (KCA_ADD_PLUGIN_STATIC)
        ...
        if (NOT ${plugin}_factory IN_LIST KCOREADDONS_STATIC_PLUGINS)
            set(KCOREADDONS_STATIC_PLUGINS${KCA_ADD_PLUGIN_INSTALL_NAMESPACE} "${KCOREADDONS_STATIC_PLUGINS};${plugin}_factory" CACHE INTERNAL "list of known static plugins for ${KCA_ADD_PLUGIN_INSTALL_NAMESPACE} namespace, used to generate Q_IMPORT_PLUGIN macros")
        endif()
    else()
...
function(kcoreaddons_target_static_plugins app_target plugin_namespace)
    ...
    foreach(PLUGIN_CLASS_NAME IN LISTS KCOREADDONS_STATIC_PLUGINS${plugin_namespace})
        if (PLUGIN_CLASS_NAME)
            set(IMPORT_PLUGIN_STATEMENTS "${IMPORT_PLUGIN_STATEMENTS}Q_IMPORT_PLUGIN(${PLUGIN_CLASS_NAME})\;\n")
        endif()
    endforeach()
    ...
    file(WRITE ${IMPORT_PLUGIN_STATEMENTS} ${TMP_PLUGIN_FILE})
